...
var ReactHoverGrid = function (_React$Component) {
            ...
            value: function _ssrOneCharId(hover_grid_id) {
                ...
                if (this.props.server_render_ssr) {
                    if (this.props.ssr_grid_id) {
                        hover_grid_id = this.props.ssr_grid_id;
                    }
                }
    ...
    function ReactHoverGrid(props) {
        ...
        var _this$_removeStatics = _this._removeStatics(), not_static_tiles = _this$_removeStatics.not_static_tiles, static_tile = _this$_removeStatics.static_tile;
    ...
    _createClass(ReactHoverGrid, [
        ...
        },
        {
            ...
            value: function _onBrowserResize() {
                ...
                this.setState({ computed_tiles: computed_tiles });
            }
        },
        {
        ...
        },
        {
            ...
            value: function _renderServerMultiples(google_font_links) {
                ...
                for (var browser_width in this.state.pictures_tiles_rows_server) {
                    ...
                    all_server_widths.push(_react2.default.createElement('div', {
                        id: id_name,
                        key: browser_width,
                ...
                var multiple_widths = _react2.default.createElement('div', { style: edge_styles }, _react2.default.createElement('style', { dangerouslySetInnerHTML: { __html: this.props.inject_css_rules } }), _react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: google_font_links } }), _react2.default.createElement('style', { dangerouslySetInnerHTML: { __html: media_hide_grids } }), _react2.default.createElement('style', { dangerouslySetInnerHTML: { __html: this.injected_css_styles } }), all_server_widths);
        ...
        },
        {
            ...
            value: function _renderBrowserExact(google_font_links) {
                ...
                return _react2.default.createElement('div', { style: border_adjust }, _react2.default.createElement('div', null, _react2.default.createElement('style', { dangerouslySetInnerHTML: { __html: this.props.inject_css_rules } }), _react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: google_font_links } }), _react2.default.createElement('style', { dangerouslySetInnerHTML: { __html: this.injected_css_styles } }), picture_list));
            }
        },
        {
...
ReactHoverGrid.STRING_OR_ARRAY = [
...
ReactHoverGrid.propTypes = {
    ...
    static_col: _propTypes2.default.number,
