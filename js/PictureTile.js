...
var PictureTile = function (_Component) {
    ...
    function PictureTile(props) {
        ...
        if (_this.props.ssr_grid_id) {
            _this.css_grid_id = _this.props.ssr_grid_id;
        } else {
            _this.css_grid_id = _this.props.hover_grid_id;
        }
    ...
    _createClass(PictureTile, [
        ...
        },
        {
            ...
            value: function _normalImage() {
                ...
                var image_styles = new _StyleOrJsx2.default('', {
                    width: this.props.picture_width,
                    cursor: 'pointer'
                });
